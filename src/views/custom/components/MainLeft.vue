<template>
  <div class="main-left-box">
    ...
    <div class="right-box">
      ...
      <div v-else>
        <el-empty description="请在左侧选择模块"></el-empty>
      </div>
    </div>
  </div>
</template>
...
<script setup lang="ts">
  ...
  import modelOfCategory from '@/dictionary/modelOfCategory';
  ...
  const cloneData = (data: IMATERIALITEM) => {
    ...
    cptData.data = cloneDeep(MODEL_DATA_JSON[cptData.model]); //  为复制的模块添加数据
  ...
  const selectModel = (val: Array<any>, key: string) => {
    currentTitle.value = modelOfCategory[key];
